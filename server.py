...
logServer1 = open('logserver1.txt','w') # Abre arquivo escrita do logServer1
...
print 'Socket bind SERVER 1 completo'
...
logServer1.write(datelog + '---->' + 'Servidor 1 com IP :' + HOST + 'Iniciado na porta: ' + str(PORT) + '\n')
...
while 1:
	...
	if (pode_Alterar == False):
		conn, addr = s.accept()
		logServer1.write(datelog + '---->' + 'ABERTA CONEXAO COM CLIENTE : ' + addr[0] + ':' + str(addr[1]) + '\n')
